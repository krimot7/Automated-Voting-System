...
Module dataAdd
    ...
    Public Sub handlesVoteLogs()
        ...
        Try
            dbConnection()
            sql = "INSERT INTO `general_elections`.`voted_logs` (`BallotNo`,`IDNo`,`Name`,`Course`,`Department`,`President`,`VPInternal`,`VPExternal`,`Secretary`,`Auditor`,`Treasurer`,`Chairman`,`ViceChairman`,`LocalSecretary`,`LocalTreasurer`,`LocalAuditor`,`BoardMember1`,`BoardMember2`,`BoardMember3`,`BoardMember4`,`BoardMember5`,`Time`,`Date`) " &
